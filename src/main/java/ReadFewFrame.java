...
public class ReadFewFrame {
    ...
    public static void main(String[] args) throws Exception {
        ...
        av_image_fill_arrays(pFrameRGB.data(), pFrameRGB.linesize(), buffer, AV_PIX_FMT_RGB24, codec_ctx.width(), codec_ctx.height(), 1);
        ...
        while (av_read_frame(fmt_ctx, pkt) >= 0) {
            ...
            // if (fi && ++i <= 5) {
            if (ret2 >= 0 && ++i <= 5) {
                sws_scale(sws_ctx, frm.data(), frm.linesize(), 0, codec_ctx.height(), pFrameRGB.data(), pFrameRGB.linesize());
